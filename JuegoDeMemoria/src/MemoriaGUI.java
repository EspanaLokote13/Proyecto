...
Colaboracion: Se compone de objetos de la clase Botones, y utiliza un objeto de la clase 
...
public class MemoriaGUI extends JFrame{
	...
	public void ventanaInicial(){
		...
		logo = new JLabel();
		ImageIcon icon = new ImageIcon(getClass().getResource("/Imagenes/a.jpg")); 
		logo.setIcon(icon);
